...
var Editor = /** @class */ (function () {
    ...
    Editor.prototype.initialize = function () {
        ...
        this.$editable.on('keydown', function (event) {
            ...
            _this.snapshot = _this.history.makeSnapshot();
            ...
            if (_this.isLimited(1, event)) {
                var lastRange = _this.getLastRange();
            ...
            if (_this.isLimited(0) && _this.snapshot) {
                _this.history.applySnapshot(_this.snapshot);
            }
        });
    ...
    Editor.prototype.setLastRange = function (rng) {
        if (rng) {
            this.lastRange = rng;
        }
        else {
