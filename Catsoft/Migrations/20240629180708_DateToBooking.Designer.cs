...
namespace App.Migrations
{
    ...
    [Migration("20240629180708_DateToBooking")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Models.Booking.PersonBookingModel", b =>
                {
                    ...
                    b.Property<int>("PersonBookingSource")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SelectedTimes")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("App.Models.Games.GameModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("App.Models.Games.GameTagModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("App.Models.Games.GameModel", b =>
                {
                    b.HasOne("App.Models.ImageModel", "ImageModel")
                        .WithOne("GameModel")
                        .HasForeignKey("App.Models.Games.GameModel", "ImageModelId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("GameModelGameTagModel", b =>
                {
                    b.HasOne("App.Models.Games.GameModel", null)
                        .WithMany()
                        .HasForeignKey("GameModelsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("App.Models.Games.GameTagModel", null)
                        .WithMany()
