...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhPopovich.Models.CommentModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PhPopovich.Models.ProjectModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PhPopovich.Models.CommentModel", b =>
                {
                    b.HasOne("PhPopovich.Models.ArticleModel", "ArticleModel")
            ...
            modelBuilder.Entity("PhPopovich.Models.ImageModel", b =>
                {
                    ...
                    b.HasOne("PhPopovich.Models.ProjectModel", "ProjectModelGallery")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("PhPopovich.Models.Pages.BlogPageModel", b =>
                {
                    b.HasOne("PhPopovich.Models.ImageModel", "MetaImageModel")
                        .WithOne("BlogPageModelMeta")
                        .HasForeignKey("PhPopovich.Models.Pages.BlogPageModel", "MetaImageModelId")
                        .OnDelete(DeleteBehavior.SetNull);
                });
            ...
            modelBuilder.Entity("PhPopovich.Models.Pages.MainPageModel", b =>
                {
                    b.HasOne("PhPopovich.Models.ImageModel", "MetaImageModel")
                        ...
                        .HasForeignKey("PhPopovich.Models.Pages.MainPageModel", "MetaImageModelId")
                        .OnDelete(DeleteBehavior.SetNull);
                });
            ...
            modelBuilder.Entity("PhPopovich.Models.ProjectModel", b =>
                {
                    b.HasOne("PhPopovich.Models.ImageModel", "ImageModel")
                        ...
                        .HasForeignKey("PhPopovich.Models.ProjectModel", "ImageModelId")
                        .OnDelete(DeleteBehavior.SetNull);
                });
            ...
            modelBuilder.Entity("PhPopovich.Models.ServiceModel", b =>
                {
                    b.HasOne("PhPopovich.Models.ImageModel", "ImageModel")
                        ...
                        .HasForeignKey("PhPopovich.Models.ServiceModel", "ImageModelId")
                        .OnDelete(DeleteBehavior.SetNull);
                });
