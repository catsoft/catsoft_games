...
namespace YoutubeSubs.data
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        {
            VideoWithLocalizations =
                await _youtubeApi.GetVideoWithLocalizationsById(SelectedVideo.Snippet.ResourceId.VideoId);
        }

        public async void TranslateLocalizations(bool forced = false)
        {
        ...
        private async Task<VideoLocalization> TranslateLocalization(string countryCode, string title,
            string description)
        {
